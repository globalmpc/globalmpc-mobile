  ...
  static final WalletAccount _wallet = WalletAccount(
    ...
    transactions: [
      ...
      WalletTransaction(
        ...
        direction: TxDirection.incoming,
        amount: 174450,
        // Deliberately not a real address. The previous placeholder collided
        // with the production Polygon MPC contract, which risked a reader
        // treating demo data as an on-chain fact.
