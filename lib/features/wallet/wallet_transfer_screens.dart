...
class _SendScreenState extends State<SendScreen> {
  ...
  Widget _review() {
    ...
    final transferUsd = _amountValue * 0.25;
                    ...
                    Flexible(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            hasEnoughBnb ? '≈ \$0.03' : 'Not enough BNB',
                            textAlign: TextAlign.right,
                            style: TextStyle(
                              color: hasEnoughBnb
                                  ? p.textLo
  ...
  // Kept temporarily as a comparison reference while the simplified review is
  // being evaluated. It is not part of the active user flow.
  // ignore: unused_element
  Widget _denseReviewReference() {
    final p = context.palette;
    final hasEnoughBnb = _wallet!.bnbBalance >= _networkFee;
    final transferUsd = _amountValue * 0.25;
    const feeUsd = 0.03;
    return ListView(
      children: [
                  ...
                  children: [
                    ...
                    const Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 3),
                        Text('≈ \$0.03', style: TextStyle(fontSize: 13)),
                      ],
                    ),
                  ],
                ),
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 3),
                            Text(
                              '≈ \$${(transferUsd + feeUsd).toStringAsFixed(2)}',
                              style: TextStyle(color: p.textLo, fontSize: 13),
                            ),
                          ],
                        ),
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              'MPC is held in your MPC wallet and never leaves your control.',
                              style: TextStyle(
                                color: p.textLo,
                                fontSize: 12.5,
                                height: 1.35,
        ...
        ExpansionTile(
          ...
          children: [
            _ReviewRow(
              label: 'Available after send',
              value:
                  '${Fmt.token((_wallet!.mpcBalance - _wallet!.allocatedTotal - _amountValue).clamp(0, double.infinity))} MPC',
            ),
            _ReviewRow(
              label: 'Fee balance',
              value: '${_wallet!.bnbBalance.toStringAsFixed(5)} BNB',
            ),
          ],
        ),
        const SizedBox(height: 24),
...
class _SendReviewSection extends StatelessWidget {
  const _SendReviewSection({required this.label, required this.child});
