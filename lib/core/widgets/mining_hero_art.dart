...
/// Visual theme for project heroes. Kept illustrative on purpose:
/// globalmpc.tech does not publish site photography for Tsagaan Tolgoi, and
/// public records for the historical "Tsagaan Tolgoi" name mostly refer to a
/// thermal-coal deposit — not the Si / Li / REE block MPC describes. We never
/// paste stock mine photos and label them as this asset.
enum MiningHeroKind {
  /// Silicon · lithium · rare-earth framing over South-Gobi terrain.
  strategicMinerals,
