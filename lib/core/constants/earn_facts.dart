/// Planned "Earn" capabilities for MPC.
///
/// Source: product direction (2026-07-16): add staking and farming via
/// smart contract. MPC issuance is designed on the
/// permissioned **ERC-3643** standard
/// and is **pre-listing**, so no reward rate is published anywhere. These are
/// therefore declared as *planned, listing-gated* capabilities and the UI must
/// never show an invented APY / pool size. Keeping the structure here (and the
/// copy in the localization tables) keeps that honesty rule in one place.
class EarnFacts {
  const EarnFacts._();

  /// The two capabilities named in the directive, in display order.
